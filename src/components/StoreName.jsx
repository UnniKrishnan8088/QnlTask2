export default function StoreName() {
  return (
    <div className="bg-white w-[15.62rem] m-auto mt-[1.6rem] p-[1rem] rounded-[1rem] border border-[#838282]">
      ...
      <div className="flex items-center justify-between border-t border-gray-400 pt-1">
